...
import { Send, Phone, Video, Paperclip, Smile, MoreVertical, X, Search } from 'lucide-react';
      ...
      <div className="w-80 bg-gray-50 dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col">
        ...
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Canlı Destek</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400">{activeUsersCount} aktif</p>
            </div>
            <button
              onClick={onClose}
